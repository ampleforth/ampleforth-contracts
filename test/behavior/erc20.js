// This file tests the general behavior of ERC20 tokens
// Inspired from : https://github.com/OpenZeppelin/zeppelin-solidity/blob/master/test/token/ERC20
...
function StandardTokenBasicBehavior (token, initialTotalSupply, owner, anotherAccount, recipient, refreshFn) {
  describe('StandardTokenBasicBehavior', () => {
    before(async () => {
      await refreshFn();
    });
...
function StandardTokenTransferBehavior (token, owner, anotherAccount, recipient, refreshFn) {
  describe('StandardTokenTransferBehavior', () => {
...
function StandardTokenApprovalBehavior (token, owner, anotherAccount, recipient, refreshFn) {
  describe('StandardTokenApprovalBehavior', () => {
...
function StandardTokenBehavior (token, initialTotalSupply, owner, anotherAccount, recipient, refreshFn) {
  if (!refreshFn) { refreshFn = async () => { }; }
  StandardTokenBasicBehavior(token, initialTotalSupply, owner, anotherAccount, recipient, refreshFn);
  StandardTokenTransferBehavior(token, owner, anotherAccount, recipient, refreshFn);
  StandardTokenApprovalBehavior(token, owner, anotherAccount, recipient, refreshFn);
}

module.exports = {
  StandardTokenBasicBehavior,
  StandardTokenTransferBehavior,
  StandardTokenApprovalBehavior,
