...
library ECDSA {
    ...
    function recover(
        ...
        // make the signature unique. Appendix F in the Ethereum Yellow paper
        // (https://ethereum.github.io/yellowpaper/paper.pdf), defines the valid range
        // for s in (281): 0 < s < secp256k1n ÷ 2 + 1, and for v in (282): v ∈ {27, 28}. Most
        ...
        // flip v from 27 to 28 or vice versa. If your library also generates signatures with 0/1
